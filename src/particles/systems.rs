...
use crate::{
    laser::components::Laser, particles::resources::ProjectileImpactParticleEffect,
    player::components::Player, rcs::components::RCSBooster,
};
...
pub fn setup_projectile_impact_particle_system(
    ...
    commands.insert_resource(ProjectileImpactParticleEffect(effect_handle.clone()));
