use bevy::{ecs::{event::EventReader, schedule::NextState, system::{Res, ResMut}}, input::{keyboard::{KeyCode, KeyboardInput}, Input}};

use crate::{ui::context_clue::resources::{ContextClue, ContextClues}, AppState};
